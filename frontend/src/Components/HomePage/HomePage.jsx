...
const row1 = [
  ...
  },
  {
    ...
    feedback:
      "I can track my phone-a week taps and I'm ready to get into my work",
        ...
        <div>
          <Box maxW={['', '80%']} m={'auto'}>
            <Text fontSize={['2xl', '4xl']} className="homepage_text">
              ...
              <span className="homepage_text_span"> time tracker</span> for
              teams
            </Text>
          </Box>
          <Box maxW={['80%', '45%']} m={'auto'}>
            <Text fontSize={['sm', 'xl']} textAlign={'center'}>
              Time tracking software used by millions. Clockify is a time
              tracker and timesheet app that lets you track work hours across
              projects. Unlimited users, free forever.
              ...
              <Heading mb={'1'} size={'sm'}>
                <Flex className="box_img">
                  ...
                  <Image
                    ml={2}
                    className="img"
                    src="https://clockify.me/assets/images/arrow-right-blue-circle-small.svg"
                  ></Image>
                </Flex>
              </Heading>
